...
<!-- SECTION:PLAN:BEGIN -->
1. Complete `TASK-003.1` first to define the temporary `etre`-only drill contract, including pronoun ordering, expected answers, and score inputs.
2. Complete `TASK-003.2` next to build the main drill page layout with pronouns on the left and six answer inputs on the right.
3. Complete `TASK-003.3` after the base form exists to add the show-answer and hide-answer interaction while preserving typed user responses.
4. Complete `TASK-003.4` last to submit the learner's answers into a dedicated results page that shows correct answers and a summary score.
<!-- SECTION:PLAN:END -->
