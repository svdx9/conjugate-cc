...
<!-- SECTION:PLAN:BEGIN -->
1. Complete `TASK-007.1` to define the drill contract (types + provider interface) and stub dataset.
2. Complete `TASK-007.2` to build the single-input drill component.
3. Complete `TASK-007.3` to expand to the six-input full conjugation form.
4. Complete `TASK-007.4` to add the results summary after submission.
5. Complete `TASK-007.5` to port and adapt the existing conjugation engine.
6. Complete `TASK-007.6` to integrate the engine with the drill interface, replacing stubs.
<!-- SECTION:PLAN:END -->
